...
routes.route(routeNames.roleSignup).post(userController.roleSignup)
...
routes.route(routeNames.getFrontendDeveloper).get(userController.getFrontendDeveloper)
routes.route(routeNames.updateLanguage).post(authJwt.verifyToken, userController.updateLanguage)
routes.route(routeNames.completeOnboarding).post(authJwt.verifyToken, userController.completeOnboarding)
